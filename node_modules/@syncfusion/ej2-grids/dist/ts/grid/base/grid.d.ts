...
import { IDialogUI, ScrollPositionType, ActionArgs, ExportGroupCaptionEventArgs, FilterUI, LazyLoadArgs, ContextMenuClickEventArgs, ContextMenuOpenEventArgs, NotifyArgs, ExportHeaders, DetailTemplateDetachArgs, BeforeCustomFilterOpenEventArgs } from './interface';
...
export declare class Grid extends Component<HTMLElement> implements INotifyPropertyChanged {
     ...
     * @returns {void}
     */
    destroyTemplate(propertyNames?: string[], index?: any, callback?: Function): void;
    /**
